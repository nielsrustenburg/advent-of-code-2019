...
namespace AoC
{
    class Doolhof<T> : Grid<T>
    {
        ...
        public Doolhof(IEnumerable<IEnumerable<T>> filledGrid, T defaultTile, IEnumerable<T> passable, bool yDecreasing = true) : base(filledGrid,defaultTile, yDecreasing)
        {
            passableTerrain = passable.ToHashSet();
        }
