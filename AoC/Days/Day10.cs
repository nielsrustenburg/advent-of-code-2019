...
namespace AoC
{
    static class Day10
    {
        ...
        public static int SolvePartOne()
        {
            ...
            AsteroidField afield = new AsteroidField(input);
            List<AsteroidVisionSet> avsets = afield.GetAsteroidVisionSets();
            return avsets.Max(x => x.VisibleAsteroidsAmount());
        }
        ...
        public static int SolvePartTwo()
        {
            ...
            AsteroidField afield = new AsteroidField(input);
            List<AsteroidVisionSet> avsets = afield.GetAsteroidVisionSets();
            AsteroidVisionSet bestAVSet = avsets.Select(set => (set, set.VisibleAsteroidsAmount())).Aggregate((a, b) => a.Item2 > b.Item2 ? a : b).Item1;
            Asteroid twohundredthAsteroid = bestAVSet.NthAsteroidHitByLaser(199);
            return twohundredthAsteroid.X * 100 + twohundredthAsteroid.InvertedY;
        }
    }
